...
async function GnomeSort() {
    ...
    while (idx < bars.length) {
        ...
        var value1 = parseInt(bars[idx].childNodes[0].innerHTML);
        var value2 = parseInt(bars[idx - 1].childNodes[0].innerHTML);
        ...
        if (value1 >= value2) {
            ...
            await new Promise((resolve) => setTimeout(() => { resolve(); }, delay));
            bars[idx - 1].style.backgroundColor = "red";

            await new Promise((resolve) => setTimeout(() => { resolve(); }, delay));

            var temp1 = bars[idx].style.height;
            var temp2 = bars[idx].childNodes[0].innerText;

            l6.style.backgroundColor = "lightgreen";

            await new Promise((resolve) => setTimeout(() => { resolve(); }, delay));

            bars[idx].style.height = bars[idx - 1].style.height;
            bars[idx].childNodes[0].innerText = bars[idx - 1].childNodes[0].innerText;
            bars[idx - 1].style.height = temp1;
            bars[idx - 1].childNodes[0].innerText = temp2;
            ...
            bars[idx + 1].style.backgroundColor = "rgb(236, 190, 53)";
            bars[idx].style.backgroundColor = "rgb(236, 190, 53)";
        }
        await new Promise((resolve) => setTimeout(() => { resolve(); }, delay));
